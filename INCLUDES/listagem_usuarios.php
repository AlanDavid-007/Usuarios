...
<section>
        <?php foreach ($usuarios as $key => $value) { ?>
            ...
            <h5 class="card-header"><?php echo $value['nome'], $value['sobrenome']; ?></h5>
            <div class="card-body" id="myTable">
                        <h5 class="card-title">Id:<?php echo $value['id']; ?></h5>
                        <p class="card-text">
                            Idade: <?php echo $value['idade']; ?> <br>
                            <p>CPF: <?php echo $value['cpf']; ?><p> <br>
                            Descrição:<?php echo $value['descricao']; ?><br>
                            Status: <?php echo ($value['sexo'] == 'f' ? 'Feminino' : ''); ?>
                            <?php echo ($value['sexo'] == 'm' ? 'Masculino' : ''); ?>
                            <?php echo ($value['sexo'] == 'i' ? 'Irreconhecido' : ''); ?> <br>
                            Ordem: <?php echo $value['ordem']; ?> <br>
                            Status: <?php echo ($value['status'] == 1 ? 'Ativo' : 'Inativo');       ?>
                        </p>
                        <a href="../Editar/editar_usuarios.php?id=<?php echo $value['id']; ?>" style="margin-right:10px;">
                        ...
                        <a href="../Excluir/excluir_usuarios.php?id=<?php echo $value['id']; ?>" style="margin-right:10px;">
